  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="目标状态(0:已发布，1:已废止，2:草稿)" prop="state">
        <el-input v-model="queryParams.state" placeholder="请输入目标状态(0:已发布，1:已废止，2:草稿)" clearable
          @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="是否是组目标" prop="isMain">
        <el-input v-model="queryParams.isMain" placeholder="请输入是否是组目标" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
