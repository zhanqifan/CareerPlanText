<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini"  @click="handleAdd"
          v-hasPermi="['student:position:edit']">设置主目标</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="positionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="创建时间" align="center" prop="positionName" />
      <el-table-column label="总体完成率" align="center" prop="positionName" />
      <el-table-column label="本年度1-6月项目数" align="center" prop="positionName" />
      <el-table-column label="本年度1-6月完成率" align="center" prop="positionName" />
      <el-table-column label="本年度7-12月项目数" align="center" prop="positionName" />
      <el-table-column label="本年度7-12月完成率" align="center" prop="positionName" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
            v-hasPermi="['student:position:edit']">编辑</el-button>
          <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)"
            v-hasPermi="['student:position:remove']">目标自评</el-button>
            <el-button size="mini" type="text" icon="el-icon-delete" @click="handleDelete(scope.row)"
            v-hasPermi="['student:position:remove']">废止</el-button>
        </template>
      </el-table-column>
    </el-table>
